=============================================================================
    DYNAMIC LINK LIBRARY : CPCShellExtContextMenuHandler Project Overview
=============================================================================
...
contains the build result CPCShellExtContextMenuHandler.dll and enter the 
command:

    Regsvr32.exe CPCShellExtContextMenuHandler.dll

The context menu handler is registered successfully if you see a message box 
saying:

    "DllRegisterServer in CPCShellExtContextMenuHandler.dll succeeded."
...
command:
    ...
    Regsvr32.exe /u CPCShellExtContextMenuHandler.dll

The context menu handler is unregistered successfully if you see a message 
box saying:

    "DllUnregisterServer in CPCShellExtContextMenuHandler.dll succeeded."
...
you will get a DLL: CPCShellExtContextMenuHandler.dll. Start a command prompt 
...
"CPCShellExtContextMenuHandler". In the "Application Settings" page of Win32 
    ...
    HKCR
    {
        NoRemove CLSID
        {
            ForceRemove {BFD98515-CD74-48A4-98E2-13D209E3EE4F} = 
                s 'CPCShellExtContextMenuHandler.FileContextMenuExt Class'
            {
                InprocServer32 = s '<Path of CPCShellExtContextMenuHandler.DLL file>'
                {
        ...
        NoRemove VisualStudio.cpp.10.0
        {
            NoRemove shellex
            {
                ...
                {
                    {BFD98515-CD74-48A4-98E2-13D209E3EE4F} = 
                        s 'CPCShellExtContextMenuHandler.FileContextMenuExt'
                }
            }
        }
    }
